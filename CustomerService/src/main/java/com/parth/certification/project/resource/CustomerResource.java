...
//import com.parth.certification.project.delegate.CustomerServiceDelegate;
import com.parth.certification.project.dto.CustomerDTO;
import com.parth.certification.project.service.CustomerService;
...
//	
//	@RequestMapping(value = "/getProductDetails/{productnumber}", method = RequestMethod.GET)
//	public String getProducts(@PathVariable String productNumber) {
//		return customerServiceDelegate.callProductServiceAndGetDate(productNumber);
//	}
